...
def create_grammar() -> GrammarEx:
    ...
    G.add_production('DeclPrime', ['semicolon'])  # 58
    G.add_production('DeclPrime', ['=', 'ExprL', 'semicolon'])  # 59
    G.add_production('Stmt', ['IfStmt'])  # 60
    G.add_production('Stmt', ['WhileStmt'])  # 61
    G.add_production('IfStmt',
                     ['if', 'lparen', 'ExprL', 'rparen', 'lbrace', 'Decls', 'rbrace', 'ElsePart', 'endif'])  # 62
    G.add_production('ElsePart', ['else', 'lbrace', 'Decls', 'rbrace'])  # 63
    G.add_production('ElsePart', [])  # 64
    G.add_production('WhileStmt', ['while', 'lparen', 'ExprL', 'rparen', 'lbrace', 'Decls', 'rbrace', 'endwhile'])  # 65
    ...
    G.add_production('ExprRPrime', ['plus', 'ExprRTerm', 'ExprRPrime'])  # 75
    G.add_production('ExprRPrime', ['minus', 'ExprRTerm', 'ExprRPrime'])  # 76
    G.add_production('ExprRPrime', [])  # 77
    G.add_production('ExprRTerm', ['Factor', 'ExprRTermPrime'])  # 78
    G.add_production('ExprRTermPrime', ['times', 'Factor', 'ExprRTermPrime'])  # 79
    G.add_production('ExprRTermPrime', ['divide', 'Factor', 'ExprRTermPrime'])  # 80
